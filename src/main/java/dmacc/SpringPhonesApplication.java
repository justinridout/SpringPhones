...
/*
 * @Autowired PhoneRepository repo;
 * 
 ...
 * 
 * Phones p = appContext.getBean("phones", Phones.class); repo.save(p);
 * 
 ...
 * repo.save(ph);
 * 
 * List<Phones> allMyPhones = repo.findAll(); for (Phones pl : allMyPhones) {
